...
from gspeedometer.controllers import device, smartScheduler
        ...
        try:
            ...
            for measurement_dict in measurement_list:
                ...
                if measurement.success == True and measurement.type == "ping":
                    if ('target' in measurement_dict['parameters']) and measurement_dict['parameters'][
                        ...
                        if record != None:
                            ...
                            record.put()
                    elif ('target' in measurement_dict['parameters']) and not (
                                measurement_dict['parameters']['target'] in CDN_TARGETS):
